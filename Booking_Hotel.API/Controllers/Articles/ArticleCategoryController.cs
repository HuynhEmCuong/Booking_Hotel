...
namespace Booking_Hotel.API.Controllers
{
    public class ArticleCategoryController : BaseApiController
    {
        ...
        [HttpPost]
        public async Task<ActionResult> AddAsync([FromBody] ArticleCategoryViewModel model)
        {
            return StatusCodeResult(await _service.AddAsync(model));
        }

        [HttpPut]
        public async Task<ActionResult> UpdateAsync([FromBody] ArticleCategoryViewModel model)
        {
        ...
        //[HttpPost]
        //public async Task<ActionResult> Validate([FromBody] ArticleCategoryViewModel model)
        //{
